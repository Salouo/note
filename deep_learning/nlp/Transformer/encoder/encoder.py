...
def main(device, train_data, test_data, vocab_size):
    ...
    try:
        tokenizer = Tokenizer.from_file("./Transformer/project/my_tokenizer.json")
        ...
        tokenizer.save("./Transformer/project/my_tokenizer.json")
    ...
    class TransformerModel(nn.Module):
        ...
        def __init__(self, ntokens, d_model, nhead, num_layers, dropout, d_hid, out_class):
            ...
            encoder_layer = TransformerEncoderLayer(d_model=d_model, nhead=nhead, dim_feedforward=d_hid)
